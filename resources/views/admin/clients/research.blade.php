  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <div class="d-sm-flex align-items-center justify-content-between">
        <h4 class="m-0 font-weight-bold text-primary">Add Research Center & Institute</h4>
        <a href="{{ route('researchlist') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-create fa-sm text-white-50"></i>Research center List</a>
      </div>
    </div>
    <div class="card-body">
      <div class="row">
        <div class="col-lg-12">
          <div class="p-5">
            <form class="user" method="post" action="{{ route('researchSave') }}" enctype="multipart/form-data">
              @csrf
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <input type="text" name="address" class="form-control @error('address') is-invalid @enderror" id="exampleAddress" placeholder="Location" value="{{ old('address') }}" >
                </div>
              </div>
              <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                ...
                {{-- <div class="col-sm-5">
                  <input type="text" name="tags" class="form-control @error('tags') is-invalid @enderror" id="exampleTags" placeholder="Tags" value="{{ old('tags') }}" >
                </div>
                <div class="col-sm-1">
