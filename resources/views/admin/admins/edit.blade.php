  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <div class="row">
        <div class="col-lg-12">
          <div class="p-5">
            <form class="user" method="post" action="{{ route('users.update', $admin->id) }}" enctype="multipart/form-data">
              @csrf
              @method('PUT')
              <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                  <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="exampleName" placeholder="Name" value="{{ $admin->name }}" required>
              ...
              <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                  <input type="email" name="email" value="{{ $admin->email }}" class="form-control @error('email') is-invalid @enderror" id="exampleInputEmail" placeholder="Email Address" required>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6 text-center">
                  @if($admin->userImg)
                    <img src="{{ url('public/'.$admin->userImg) }}" id="staffPreviewImage" height="100px" width="100px">
                  @else
