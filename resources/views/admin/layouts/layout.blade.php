...
<head>
  ...
  <!-- Toastr -->
  <link rel="stylesheet" href="{{ url('public/common/js/toastr/toastr.min.css') }}">
...
<body id="page-top">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" data-toggle="modal" data-target="#logoutModal" href="{{ route('logout') }}"
  ...
  <!-- Toastr -->
  <script src="{{ url('public/common/js/toastr/toastr.min.js') }}"></script>

  <script src="{{ url('public/common/js/custom.js') }}"></script>
